...
class CalcGLP(): # Cálculo de centrais prediais de GLP
   ...
   def exportar_para_excel(self):
      ...
      if not self._pot_equipamentos:
         messagebox.showerror('ERRO!', 'Nenhum equipamento adicionado!')
         return
      else:
         tipo_cilindro = self.combo_tipos.get()
         equipamentos_data = []
         ...
         # Criar o nome do arquivo com data
